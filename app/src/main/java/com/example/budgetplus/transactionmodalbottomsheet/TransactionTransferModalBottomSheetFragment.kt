...
class TransactionTransferModalBottomSheetFragment : BottomSheetDialogFragment(),
    ...
    private val transactionModalBottomSheetViewModel: Lazy<TransactionModalBottomSheetViewModel> =
        KoinJavaComponent.inject(TransactionModalBottomSheetViewModel::class.java)
    ...
    private fun initObservers() {
        transactionModalBottomSheetViewModel.value.transactionAdd
    ...
    private fun transactionTransferAction() {
        if (checkTransactionValidation()) {
            transactionModalBottomSheetViewModel.value.addTranasction(getTransactionRequestBody())
        }
    }
